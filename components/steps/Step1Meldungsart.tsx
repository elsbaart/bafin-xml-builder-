    ...
    <div className="space-y-5">
      ...
      <div>
        <Label className="flex items-center gap-1">
          ...
          <FieldHelp text="INIT: Erstmeldung für diesen Meldezeitraum. AMND: Korrektur einer bereits übermittelten Meldung — auch ohne vorheriges INIT möglich. Typisch für VRUK: INIT." />
        </Label>
      ...
      <div>
        <Label className="flex items-center gap-1">
          ...
          <FieldHelp text="1 = Vollständige Meldung nach Art. 24 Abs. 1 (zugelassene KVG). 2 = Vereinfachte Meldung nach Art. 3 Abs. 3 d) für registrierte KVGen. 3 = Vollständige Meldung für in DE vertriebene AIF. Typisch für VRUK als registrierte KVG: 2." />
        </Label>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <Label className="flex items-center gap-1">
            ...
            <FieldHelp text="Startdatum des Meldezeitraums im Format JJJJ-MM-TT. Für jährliche Meldung (Y1): immer 01.01. des Meldejahres. Beispiel VRUK 2025: 2025-01-01." />
          </Label>
          <Input
            type="date"
            className="mt-1"
        ...
        <div>
          <Label className="flex items-center gap-1">
            ...
            <FieldHelp text="Enddatum des Meldezeitraums im Format JJJJ-MM-TT. Für jährliche Meldung (Y1): immer 31.12. des Meldejahres. Beispiel VRUK 2025: 2025-12-31." />
          </Label>
          <Input
            type="date"
            className="mt-1"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <Label className="flex items-center gap-1">
            ...
            <FieldHelp text="Y1 für jährliche Meldepflicht (registrierte KVGen nach Art. 3). Q1–Q4 für quartalsweise, H1/H2 für halbjährliche Meldungen (zugelassene KVGen). Typisch für VRUK: Y1." />
          </Label>
        ...
        <div>
          <Label className="flex items-center gap-1">
            ...
            <FieldHelp text="Vierstelliges Kalenderjahr des Meldezeitraums. Gültig: aktuelles Jahr sowie die zwei vorangegangenen Kalenderjahre." />
          </Label>
          <Input
            type="number"
            className="mt-1"
      ...
      <div className="flex items-start gap-3 p-3 border rounded-md">
        ...
        <div>
          <Label htmlFor="lastReporting" className="cursor-pointer flex items-center gap-1">
            ...
            <FieldHelp text="Nur aktivieren wenn dies die letzte Meldung ist und keine Folgemeldungen mehr eingereicht werden (z.B. bei Auflösung der KVG). Andernfalls werden weitere Meldungen von der BaFin erwartet und ggf. angemahnt. Normalfall: nicht aktiviert." />
          </Label>
          <p className="text-xs text-muted-foreground mt-0.5">Nur bei endgültiger Einstellung der Geschäftstätigkeit aktivieren</p>
        </div>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <Label className="flex items-center gap-1">
            ...
            <FieldHelp text="Optionaler Block für Anmerkungen zu bestimmten Datenpunkten. Typisch: Fragennummer 1, Beschreibung 'None' — als Pflatzhalter wenn keine Annahmen getroffen wurden. Max. 300 Zeichen pro Eintrag." />
          </Label>
